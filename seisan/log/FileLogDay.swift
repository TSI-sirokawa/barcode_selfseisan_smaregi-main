...
/// 　　　　　　・・・｀
/// 　　　X月31日のログ: log31.csv
final class DayFileLogger: LogHandler {
    private let label: String
    private var setting: DayFileLogger.Setting
    ...
    init(label: String, setting: DayFileLogger.Setting) {
        self.label = label
        self.setting = setting
    }
    
    func updateSetting(setting: DayFileLogger.Setting) {
        self.setting = setting
