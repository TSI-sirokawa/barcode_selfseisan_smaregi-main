//
//  PatientCardSeisanFinalizeView.swift
//  seisan
//
...
struct PatientCardSeisanFinalizeView: View {
    private let log = Logger(label: Bundle.main.bundleIdentifier!)
    
    @EnvironmentObject var appState: AppState
    @StateObject var viewModel =  PatientCardSeisanFinalizeViewModel()
